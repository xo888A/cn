<?php 
    ...
    foreach($articles as $article){
        ...
        $data .= "<li>
                        <a class='tag' href='{$article['downloadurl']}' target='_blank'>下载</a>
                        <img src='{$article['cover']}' />
                        <div>
                            <p class='p1'>{$article['name']}</p>
                            <p class='p2'>{$article['num']}.00万次下载</p>
    ...
    $tpl =  new Society();
    $html =  "<img class='nodata' src='{$tu}/nodata.png'><p class='center nd'>暂无关注哦~</p>";
