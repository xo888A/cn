<?php 
    ...
    $index = INDEX;
    $ul = "<li class='{$a1}'><p class='abs'></p><a href='{$index}/index.php?mod=rank'>全部动态</a></li>
                    <li  class='{$a2}'><p class='abs'></p><a href='{$index}/index.php?mod=rank&type=video'>视频</a></li>
                    <li class='{$a3}'><p class='abs'></p><a href='{$index}/index.php?mod=rank&type=organ'>社区</a></li>";
    $tpl->assign('ul',$ul);
