<?php 
	...
	if($id){
		...
		$button = "<a href='javascript:;' class='btn submit' rel='updateorgan'><i class='fa fa fa-edit'></i>更新</a>";
	    ...
	    $button = "<a href='javascript:;' class='btn submit' rel='addorgan'><i class='fa fa-plus-square-o'></i>添加</a>";
	}
