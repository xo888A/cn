<?php
    ...
    class functions{
        ...
        static function cut($str,$l=15){
            return self::cutstr($str,$l)."<a style='color:#FF7AA5' href='javascript:;' class='xq' data='{$str}'>[详情]</a>";
        }
        ...
        static function cut2($str,$l=15){
            return self::cutstr($str,$l)."<a style='color:#FF7AA5' href='javascript:;' onclick='openalert(\"{$str}\")'>[详情]</a>";
        }
        ...
        **/
        ...
        static function getnewtips($vipdiam,$diam){
            if($vipdiam){
              $tips = "<p class='num abs'>{$diam}金币</p>";
            }elseif (!$vipdiam && $diam) {
	    ...
	    function follow($user,$tpl){
	        ...
	        if($isfollow){
                $tpl->assign('guanzhu',"<a href='javascript:;' class='followuser user_{$user}' user='{$user}'  style='background:#ccc'>已关注</a>");
            }else{
                $tpl->assign('guanzhu',"<a href='javascript:;' class='followuser user_{$user}' user='{$user}'>关注</a>");
            }
	    }
	    function history($id){
	        $db = self::db();
	    ...
	    static function gettopiclist(){
            ...
            <ul class='overflow datatopic'>
                {$t}
                <li class='special'><a href='javascript:;' onclick=\"openwin('alltopiclist','reload')\">查看全部分类+</a></li>
            </ul>
        </div>";
            return $menu;
