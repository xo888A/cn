<?php 
    ...
    foreach ($topics as $topic){
		...
		$data .= "<tr>
                    ...
                    <td>
                    	<a class='btn btn2' rel='updatetopic'  href='{$href}'><i class='fa fa-edit'></i>编辑</a>
                    	<a class='btn btn3 del' rel='topic' id='{$topic['id']}' href='javascript:;'><i class='fa fa-trash'></i>删除</a>
            		</td>
                </tr>";
    }
