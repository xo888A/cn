...
<body>
    ...
    <div class="dowmload"  style="margin-top:10px">
        <div class="rel dw">
            <div class="abs">
                <p class="download"><img class="android" src="<?php echo IMG ?>/android.png">安卓下载</p>
                <p class="download"><img class="ios" src="<?php echo IMG ?>/ios.png">iPhone下载</p>
            </div>
            <img class="w100"  src="<?php echo IMG ?>/appbg-m.jpg">
        </div>
        <div class="phone center" >
            <p class="selected" rel="android"><span></span>安卓手机教程</p>
            <p rel="ios"><span></span>iPhone安装教程</p>
        </div>
