...
<head>
    ...
    <title><?php echo $this->vars["nickname"] ?>的作品</title>
        ...
        <section class="section3">
            <div class="w100 fl">
                ...
                <div class="fr w88">
                    ...
                    <div class="flex">
                        <ul class="addcolor">
                            <li class="<?php echo $this->vars["css1"] ?>"><p class="abs"></p><a href="<?php echo $this->vars["a1"] ?>">全部动态</a></li>
                            <li class="<?php echo $this->vars["css2"] ?>"><p class="abs"></p><a href="<?php echo $this->vars["a2"] ?>">视频</a></li>
                            <li class="<?php echo $this->vars["css3"] ?>"><p class="abs"></p><a href="<?php echo $this->vars["a3"] ?>">社区</a></li>
                        </ul>
                        <!--<p class="fs"><span class='newfs'><?php echo $this->vars["follow"] ?></span>粉丝</p>-->
                        <!--<p class="l">|</p>-->
                        <!--<p class="fs"><span><?php echo $this->vars["count"] ?></span>作品</p>-->
