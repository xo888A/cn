    ...
    <div class="wrap">
        <div class="w100">
            ...
            <div class="content">
                ...
                <div class="frame">
                    <p class="title">短视频管理</p>
                    <div class="frmtable">
                    <table class="w100 list">
                        <tr>
                            <th><span style="color:#3FCF7F;cursor: pointer;" onclick="converSelectAll()">全选</span>/<span class='newishow' rel='post' style="color:red;cursor: pointer;">审核</span></th>
                            <th>短视频ID</th>
                            <!--<th>类型</th>-->
                            <th>封面</th>
                            <th>标题</th>
