...
<body>
   <?php file::import("system-model-top"); ?>
    <div class="wrap flr mt70">
        <div class="top rel ntop ">
            ...
            <div class="l2 abs">
                ...
                <p class="endtime">余额:<?php echo $this->vars["diam"] ?>金币</p>
            </div>
            <div class="l3 abs onclick">
                <p class="selected" rel="1">充值金币</p>
                <p rel="2">卡密兑换金币</p>
                <p rel="3">常见问题</p>
            </div>
       </div>
    ...
    <div class="wrap">
        <div class="npart1 ">
            <p class="btit">请选择要充值的金币<span class="fr"><a style="color:#FF7AA5" href="<?php echo INDEX ?>/index.php?mod=customer">需要人工客服帮助</a></span></p>
            <ul class="width3 overflow jinbi diampay">
                <?php echo $this->vars["diams"] ?>
            </ul>
            <div class="not">
                <div class="w">
                    <p><span>购买必读:</span><?php echo $this->vars["miaoshu2"] ?></p>
                </div>
            </div>
            ...
            <a href="javascript:;" id="" class="fr gopay2 addgopay">立即支付</a></p>
            </div>
        </div>
    ...
    <div class="part4 npart2 part overflow iuy wrap hide">
        <p class="notice" style="font-size:18px;margin-top:20px">使用卡密兑换金币</p>
