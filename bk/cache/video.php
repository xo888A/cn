    ...
    <div class="wrap">
        <div class="video">
            <div class="fl">
                ...
                <div class="vidmsg">
                    <div class="fl">
                        ...
                        <p><a href="<?php echo INDEX ?>/index.php?mod=shares"><img src="<?php echo TU ?>/vv4.png" /><span>推广赚钱</span></a></p>
                        <p><a href="<?php echo INDEX ?>/index.php?mod=shares"><img src="<?php echo TU ?>/vv5.png" /><span>分享送VIP</span></a></p>
                    </div>
                    <div class="fr">
                        <p><a href="<?php echo INDEX ?>/download.html"><img src="<?php echo TU ?>/download.png" /><span>下载APP永不迷路</span></a></p>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="user rel">
                    ...
                    <p class="m abs"><span class="n fs"><?php echo $this->vars["user_follow"] ?> 粉丝</span><span><?php echo $this->vars["user_descs"] ?></span></p>
                ...
                <!--<textarea placeholder="我来说两句~~" name="textarea" class="textarea"></textarea>-->
                <div class="bq rel">
                    <div><p class="control" rel="1"><img class="b c" src="<?php echo TU ?>/b1.png" />表情</p><a postid='<?php echo $this->vars["id"] ?>' class="fr fabiao" href="javascript:;" tel2='' commentid=''>发表评论</a></div>
            ...
            <div class="fr">
                ...
                <p class="rtit">热门视频<a class="more" href="<?php echo INDEX ?>/index.php?mod=rank">更多<img style="height: 26px;" src="../image/right.png"></a></p>
