<?php 
    ...
    foreach ($tuijiantopic as $val){
        ...
        $tuijian .= "<section class='public {$css}'><p class='tit'>{$val}<span class='fr mores'><a  onclick=\"opentopic('{$val}')\" href='javascript:;'>更多<img src='../image/right.png' /></a></span></p><ul class='overflow width1'>{$data}</ul></section>";
