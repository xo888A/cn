<?php 
    ...
    if($focum){
        ...
        $fabiao = "<a style='color:#fff' href='javascript:;' onclick='_fabiao2(\"$postid\",\"$tel2\",\"$commentid\")' class='fr hf cb ' postid='{}'  tel2='{}' commentid='{}'>回复评论</a>";
    }else{
        ...
        $fabiao = "<a style='color:#fff'  onclick='_fabiao(\"$postid\",\"$tel2\",\"$commentid\")' class='fr hf cb ' postid='{}'  tel2='{}' commentid='{}'>回复评论</a>";
    }
    $biaoqing = $tietu = '';;
    for($i=0;$i<=49;$i++){
        $url = TU.'/img1/'.$i.'.png';
