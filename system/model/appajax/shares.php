<?php 
        ...
        foreach ($earningses as $earnings){
            ...
            $fenhong .= "<li>
                            <div>
                                ...
                                <p class='p1'>{$earnings['currtel']}-充值{$earnings['price']}元</p>
                                <p class='p2'>{$t}</p>
    ...
    $tu = TU;
    $html =  "<div class='center'><img class='nodata' style='width: 150px !important;height:auto !important' src='{$tu}/nodata.png'><p class='center nd'>暂无报表哦~</p></div>";
    ...
    $fenhongadd = "<div class='fenhong_download'><p class='a' style='width: 100%;
            text-align: center;
            font-size: 15px;
            margin: 20px 0;'>仅记录最新20条数据,完整数据请到PC端下载后查阅!</p></div>";
    if(isphone()){
        $fenhongadd = "<div class='fenhong_download'><p class='a' style='width: 100%;
            text-align: center;
            font-size: 15px;
