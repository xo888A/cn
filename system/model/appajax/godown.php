                ...
                <div class='w rel'>
                    ...
                    <div class='padding'>
                        ...
                        <div class='r abs'>
                            ...
                            <p class='color'><a href='javascript:;' onclick='openurl(\"{$jiaocheng}\")'>手机下载解压教程?</a></p>
                        </div>
                        ...
                        <a href='javascript:;' onclick='openwin(\"vip\")' class='d' >升级VIP等级</a>
 	    ...
 	    $html = "<div class='fix downloadzip'>
                <div class='w rel'>
                    ...
                    <div class='padding'>
                        ...
                        <a href='javascript:;' class='d' onclick='openwin(\"vip\")'>升级VIP等级</a>
                    </div>
                </div>
            </div>";
 	}else{
 	    ...
 	    $html = "<div class='fix downloadzip'>
                <div class='w rel'>
                    ...
                    <div class='padding'>
                        ...
                        <a href='javascript:;' onclick='openurl(\"{$downloadurl}\")' class='d' target='_blank'>开始下载</a>
