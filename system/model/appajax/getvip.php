<?php 
    ...
    if($tel[0]['viptime']>time()){
        if($tel[0]['mylevel']=='6'){
            ...
            $viptime = date('Y-m-d',$tel[0]['viptime']).' 到期';
    ...
    foreach ($vipcards as $vipcard){
        if($vipcard['id']==1 && $vipcard['state']=='开启'){
            if($isvip){
                $add1 = "<p class='p2'><img src='{$tu}/yhq.png' />优惠券.立减¥<span class='yhq'>{$vipcard['ucard']}</span>元</p>";
            }else{
                $add1 = '';
            }
            $vip = "<li class='b1'>
                           ...
                           <div class='e1'>
                               ...
                               <p  class='y2'>¥<span class='s1'>{$vipcard['nowprice']}</span><span class='s2'>{$vipcard['oldprice']}元</span></p>
        ...
        if($vipcard['id']==2 && $vipcard['state']=='开启'){
            if($isvip){
                $add2 = "<p class='p2'><img src='{$tu}/yhq.png' />优惠券.立减¥<span class='yhq'>{$vipcard['ucard']}</span>元</p>";
            }else{
                $add2 = '';
            }
            $vip .= "<li class='b2'>
        ...
        if($vipcard['id']==3 && $vipcard['state']=='开启'){
            if($isvip){
                $add3 = "<p class='p2'><img src='{$tu}/yhq.png' />优惠券.立减¥<span class='yhq'>{$vipcard['ucard']}</span>元</p>";
            }else{
                $add3 = '';
            }
            $vip .= "<li class='b3'>
        ...
        if($vipcard['id']==4 && $vipcard['state']=='开启'){
            if($isvip){
                $add4 = "<p class='p2'><img src='{$tu}/yhq.png' />优惠券.立减¥<span class='yhq'>{$vipcard['ucard']}</span>元</p>";
            }else{
                $add4 = '';
            }
            $vip .= "<li class='b4'>
        ...
        if($vipcard['id']==5 && $vipcard['state']=='开启'){
            if($isvip){
                $add5 = "<p class='p2'><img src='{$tu}/yhq.png' />优惠券.立减¥<span class='yhq'>{$vipcard['ucard']}</span>元</p>";
            }else{
                $add5 = '';
            }
            $vip .= "<li class='b5'>
        ...
        if($vipcard['id']==6 && $vipcard['state']=='开启'){
            if($isvip){
                $add6 = "<p class='p2'><img src='{$tu}/yhq.png' />优惠券.立减¥<span class='yhq'>{$vipcard['ucard']}</span>元</p>";
            }else{
                $add6 = '';
            }
            $vip .= "<li class='b6'>
    ...
    $answers = $db->query('answer','',"wtype='VIP模块'");
    $_answer = '';
    foreach ($answers as $answer){
        $_answer .= "<li>
                            <h4>{$answer['title']}</h4>
                            <p>答: {$answer['content']}</p>
                        </li>";
    }
