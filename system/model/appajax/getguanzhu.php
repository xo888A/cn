...
<?php 
    ...
    foreach($articles as $article){
    	...
    	if($isfollow){
            $guanzhu = "<a href='javascript:;' onclick='guanzhu(\"{$article['tel2']}\")' class='followuser user_{$article['tel2']}' user='{$article['tel2']}'  style='background:#ccc'>已关注</a>";
        }else{
            $guanzhu = "<a href='javascript:;' onclick='cancelguanzhu(\"{$article['tel2']}\")' class='followuser user_{$article['tel2']}' user='{$article['tel2']}'>关注</a>";
        }
