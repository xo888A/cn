<?php 
    ...
    $ul = "<ul class='add8 publictag' style='margin-bottom:20px'>
                <li  class='{$a1}'><p class='abs'></p><a href='{$index}/index.php?mod=search&keyword={$keyword}'>全部动态</a></li>
                <li  class='{$a2}'><p class='abs'></p><a href='{$index}/index.php?mod=search&type=video&keyword={$keyword}'>视频</a></li>
                <li  class='{$a3}'><p class='abs'></p><a href='{$index}/index.php?mod=search&type=organ&keyword={$keyword}'>社区</a></li>
            </ul>";
    $tpl->assign('ul',$ul);
    if(isphone()){
