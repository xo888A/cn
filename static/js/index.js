		...
		success: function(data){
            ...
            if(data.data){
                if(data.do=='reload'){
                    ...
                    var element = "."+user;
                    //$tpl->assign('guanzhu',"<a href='javascript:;' class='guanzhu1' user='{$post[0]['userid']}'>关注</a>");
