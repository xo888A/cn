<?php 
    ...
    $adv1 = functions::get_contents(INDEX.'/webajax.php?mod=getadv&position=微社区-轮播图&isswiper=1&level='.getlevel());
    ...
    $tu = TU;
    //$html =  "<div class='center'><img class='nodata' src='{$tu}/nodata.png'><p class='center nd'>暂无内容哦~</p></div>";
    $html = '';
    ...
    if(functions::is_mobile()){
        $adv2 = functions::get_contents(INDEX.'/webajax.php?mod=getphoneadv&position=微社区-右侧6广告&num=6&level='.getlevel());
        $adv3 = functions::get_contents(INDEX.'/webajax.php?mod=getphoneadv&position=微社区-右侧4广告&num=4&part=add&level='.getlevel());
  ...
  $tpl->assign('vlist',$_vlist);  
        ...
        $adv2 = functions::get_contents(INDEX.'/webajax.php?mod=getadv&position=微社区-右侧6广告&num=6&level='.getlevel());
        $adv3 = functions::get_contents(INDEX.'/webajax.php?mod=getadv&position=微社区-右侧4广告&num=4&part=add&level='.getlevel());
        $tpl->assign('adv2',$adv2);
        $tpl->assign('adv3',$adv3);
