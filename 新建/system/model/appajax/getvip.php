<?php 
    ...
    foreach ($vipcards as $vipcard){
        if($vipcard['id']==1 && $vipcard['state']=='开启'){
            if($isvip){
                $add1 = "<p class='p2'><img src='{$tu}/yhq.png' />Thẻ khuyến mãi.Giảm¥<span class='yhq'>{$vipcard['ucard']}</span>VNĐ</p>";
            }else{
                $add1 = '';
            }
            $vip = "<li class='b1'>
        ...
        if($vipcard['id']==2 && $vipcard['state']=='开启'){
            if($isvip){
                $add2 = "<p class='p2'><img src='{$tu}/yhq.png' />Thẻ khuyến mãi.Giảm¥¥<span class='yhq'>{$vipcard['ucard']}</span>VNĐ</p>";
            }else{
                $add2 = '';
            }
            $vip .= "<li class='b2'>
        ...
        if($vipcard['id']==3 && $vipcard['state']=='开启'){
            if($isvip){
                $add3 = "<p class='p2'><img src='{$tu}/yhq.png' />Thẻ khuyến mãi.Giảm¥¥<span class='yhq'>{$vipcard['ucard']}</span>VNĐ</p>";
            }else{
                $add3 = '';
            }
            $vip .= "<li class='b3'>
        ...
        if($vipcard['id']==4 && $vipcard['state']=='开启'){
            if($isvip){
                $add4 = "<p class='p2'><img src='{$tu}/yhq.png' />Thẻ khuyến mãi.Giảm¥¥<span class='yhq'>{$vipcard['ucard']}</span>VNĐ</p>";
            }else{
                $add4 = '';
            }
            $vip .= "<li class='b4'>
        ...
        if($vipcard['id']==5 && $vipcard['state']=='开启'){
            if($isvip){
                $add5 = "<p class='p2'><img src='{$tu}/yhq.png' />Thẻ khuyến mãi.Giảm¥¥<span class='yhq'>{$vipcard['ucard']}</span>VNĐ</p>";
            }else{
                $add5 = '';
            }
            $vip .= "<li class='b5'>
        ...
        if($vipcard['id']==6 && $vipcard['state']=='开启'){
            if($isvip){
                $add6 = "<p class='p2'><img src='{$tu}/yhq.png' />Thẻ khuyến mãi.Giảm¥¥<span class='yhq'>{$vipcard['ucard']}</span>VNĐ</p>";
            }else{
                $add6 = '';
            }
            $vip .= "<li class='b6'>
