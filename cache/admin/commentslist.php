            ...
            <div class="content">
                <div class="frame">
                    ...
                    <div class="frmtable">
                        <form action="admin.php" method="get" class="search">
                            <input type="hidden" name="mod" value="commentslist" />
                            <input name="keyword" value="<?php echo CW('get/keyword')==='0' ? '' : CW('get/keyword');  ?>" placeholder="搜索评论内容,支持模糊检索" />
                            <select name="ishow">
                ...
                <div class="frame">
                    ...
                    <table class="w100 list">
                        <tr>
                            <th><span style="color:#3FCF7F;cursor: pointer;" onclick="converSelectAll()">全选</span>/<span class='ishow' rel='comments' style="color:red;cursor: pointer;">审核</span></th>
                            <th>用户</th>
                            <th>评论</th>
                            <th>帖子</th>
                            <th>发布时间</th>
