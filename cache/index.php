...
<body>
    ...
    <div class="wrap">
        ...
        <section class="public">
            <p class="tit">猜你喜欢<a href="javascript:;" class="fr resh"><img src="<?php echo TU ?>/resh.png" />换一批</a></p>
            <ul class="overflow width1 reshcontent">
                <?php echo $this->vars["data1"] ?>
            </ul>
        </section>
        <section class="public">
            <p class="tit">正在热播<span class="fr"><a href="<?php echo INDEX ?>/index.php?mod=type">更多<img src="../image/right.png" /></a></span></p>
