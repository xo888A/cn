    ...
    <div class="maincontent rel">
        ...
        <div class="rel h100">
            ...
            <div class="typecontent abs">
                ...
                <div>
                    <p class="overhid"><?php echo $this->vars["num"] ?>个内容</p>
            ...
            <div class="flex flextop">
                <ul class="publictag">
                    <li class="<?php echo $this->vars["s1"] ?>"><p></p><a href="<?php echo INDEX ?>/index.php?mod=topiclist&id=<?php echo $this->vars["id"] ?>">全部动态</a></li>
                    <li class="<?php echo $this->vars["s2"] ?>"><p></p><a href="<?php echo INDEX ?>/index.php?mod=topiclist&type=video&id=<?php echo $this->vars["id"] ?>">视频</a></li>
                    <li class="<?php echo $this->vars["s3"] ?>"><p></p><a href="<?php echo INDEX ?>/index.php?mod=topiclist&type=organ&id=<?php echo $this->vars["id"] ?>">社区</a></li>
                </ul>
            </div>
        </div>
    </div>
