...
<body>
    ...
    <div class="tg">
        <span class="selected"><a href="javascript:;">视频</a></span>
        <span class="p"><a href="javascript:;">评论</a></span>
        <strong><?php echo $this->vars["pinglun"] ?></strong>
        <a href="<?php echo INDEX ?>/download.html" class="fr"><img src="<?php echo TU ?>/download.png">下载APP不迷路</a>
    </div>
<div class="part1">
    ...
    <p class="line"></p>
    <div class="wrap">
        <p class="tit mt15"><img src="../image/hot.png" width="25" height="25" style="width: 25px; height: 25px;"/>热门视频<span class="fr"><a  href="<?php echo INDEX ?>/index.php?mod=recommend">更多<img src="../image/right.png" /></a></span></p>
