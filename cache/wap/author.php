    ...
    <div class="maincontent rel">
        ...
        <div class="rel h100">
            ...
            <div class="flex flextop">
                <ul class="publictag">
                    <li class="<?php echo $this->vars["css1"] ?>"><p></p><a href="<?php echo $this->vars["a1"] ?>">全部动态</a></li>
                    <li class="<?php echo $this->vars["css2"] ?>"><p></p><a href="<?php echo $this->vars["a2"] ?>">视频</a></li>
                    <li class="<?php echo $this->vars["css3"] ?>"><p></p><a href="<?php echo $this->vars["a3"] ?>">社区</a></li>
                </ul>
            </div>
        </div>
    </div>
