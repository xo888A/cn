        ...
        if($comments2){
            foreach ($comments2 as $comment2){
                ...
                $addcomment .= "<li>
                                    ...
                                    <div class='fl sh'>
                                        <p class='tt'>{$tel1[0]['nickname']}<span>回复</span>{$tel2[0]['nickname']}<a href='javascript:;' class='fr hfnow' postid='{$id}' tel1='{$us}' nickname='{$tel1[0]['nickname']}' tel2='{$comment2['tel1']}' commentid='{$comment['id']}'>回复</a></p>
