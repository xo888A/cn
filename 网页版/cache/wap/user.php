    ...
    <div class="wrap users mt70">
        <div class="rel">
            ...
            <div class="u abs">
                ...
                <p class="p"><?php echo $this->vars["nick"] ?><span><img class="i2" src="../image/<?php echo $this->vars["sex"] ?>.png" /></span><span ><a class="co" href="<?php echo INDEX ?>/index.php?mod=set">设置昵称<img class="i3" src="../image/u.png" /></a></span></p>
            </div>
        </div>
        <ul class="s overflow">
            <li>
