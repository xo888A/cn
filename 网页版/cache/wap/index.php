 ...
 <?php echo $this->vars["newadd"] ?>
   ...
   <div class="wrap">
    ...
    <div class="wrap swiper">
        <p class="tit mt15"><img src="../image/cai.png" width="25" height="25" style="width: 25px; height: 25px;"/>猜你喜欢<span class="fr resh"><img src="../image/resh.png" />换一批</span></p>
    ...
    <p class="line"></p>
    <div class="wrap swiper">
        <p class="tit mt15"><img src="../image/hot.png" width="25" height="25" style="width: 25px; height: 25px;"/>正在热播<span class="fr"><a href="<?php echo INDEX ?>/index.php?mod=type">更多<img src="../image/right.png" /></a></span></p>
        <div class="publicswiper swiper">
            <div class="swiper-wrapper">
