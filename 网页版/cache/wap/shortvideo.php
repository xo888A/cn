    ...
    <div class="vidheight rel">
        ...
        <div class="abs fn">
            ...
            <ul style="margin-top:20px">
                <li>
                    <a href="<?php echo $this->vars["next"] ?>">
        ...
        <div class="pinglun cms wrap hide"></div>
         <div class="abs w100  phonefix hide">
            ...
            <div class="bq">
                    <div><p class="control" rel="1"><img class="b c" src="../image/b1.png" /></p><a postid='<?php echo $this->vars["id"] ?>' class="fr fabiao" href="javascript:;" tel2='' commentid=''>发表评论</a></div>
                </div>
        </div>
