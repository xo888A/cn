...
!(function () {
                ...
                !(function (t, n) {
                        ...
                        k.each(
                            ...
                            function (e, t) {
                                k.fn[e] = function (n, r) {
                                    ...
                                    return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = k.filter(r, i)), this.length > 1 && (R[e] || k.uniqueSort(i), P.test(e) && i.reverse()), this.pushStack(i);
                                };
                            }
                        );
                    var I = /[^\x20\t\r\n\f]+/g;
                                ...
                                var t = [
                                    ...
                                    i = {
                                        ...
                                        then: function (e, n, i) {
                                                        ...
                                                        c = i
                                                            ...
                                                            : function () {
                                                                  try {
                                                                      ...
                                                                      k.Deferred.exceptionHook && k.Deferred.exceptionHook(r, c.stackTrace), e + 1 >= o && (n !== F && ((s = void 0), (u = [r])), t.rejectWith(s, u));
                                                                  }
                                                              };
                                            ...
                                            return k
                                                .Deferred(function (r) {
                                                    t[0][3].add(a(0, r, m(i) ? i : W, r.notifyWith)), t[1][3].add(a(0, r, m(e) ? e : W)), t[2][3].add(a(0, r, m(n) ? n : F));
                                                })
                                                .promise();
                                        },
                                        promise: function (e) {
                    ...
                    (k.fn.ready = function (e) {
                        ...
                        k.extend({
                            ...
                            readyWait: 1,
                            ready: function (e) {
                                (!0 === e ? --k.readyWait : k.isReady) || ((k.isReady = !0), (!0 !== e && --k.readyWait > 0) || _.resolveWith(x, [k]));
                            },
                        }),
                        (k.ready.then = _.then),
                        "complete" === x.readyState || ("loading" !== x.readyState && !x.documentElement.doScroll) ? r.setTimeout(k.ready) : (x.addEventListener("DOMContentLoaded", z), r.addEventListener("load", z));
                        ...
                        for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
                            if ((o = e[d]) || 0 === o)
                                if ("object" === T(o)) k.merge(p, o.nodeType ? [o] : o);
                                    ...
                                    for (a = a || f.appendChild(t.createElement("div")), s = (me.exec(o) || ["", ""])[1].toLowerCase(), u = xe[s] || xe._default, a.innerHTML = u[1] + k.htmlPrefilter(o) + u[2], c = u[0]; c--; )
                                        a = a.lastChild;
                            ...
                            ? (K.set(e, t, !1),
                              k.event.add(e, t, {
                                  ...
                                  handler: function (e) {
                                      ...
                                      } else o.length && (K.set(this, t, { value: k.event.trigger(k.extend(o[0], k.Event.prototype), o.slice(1), this) }), e.stopImmediatePropagation());
                                  },
                              }))
                                ...
                                for (a = k.event.handlers.call(this, u, l), t = 0; (i = a[t++]) && !u.isPropagationStopped(); )
                                    for (u.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !u.isImmediatePropagationStopped(); )
                                        (u.rnamespace && !1 !== o.namespace && !u.rnamespace.test(o.namespace)) ||
                                            ((u.handleObj = o),
                                            (u.data = o.data),
                                            void 0 !== (r = ((k.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (u.result = r) && (u.preventDefault(), u.stopPropagation()));
                    ...
                    function Re(e, t) {
                        var n, r, i, o, a, s;
                        if (1 === t.nodeType) {
                            if (K.hasData(e) && (s = K.get(e).events)) for (i in (K.remove(t, "handle events"), s)) for (n = 0, r = s[i].length; n < r; n++) k.event.add(t, i, s[i][n]);
                    ...
                    function Ie(e, t, n, r) {
                        ...
                        if (p && ((o = (i = Ce(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === i.childNodes.length && (i = o), o || r)) {
                            for (s = (a = k.map(be(i, "script"), Oe)).length; f < p; f++) (l = i), f !== d && ((l = k.clone(l, !0, !0)), s && k.merge(a, be(l, "script"))), n.call(e[f], l, f);
                            if (s)
                                for (c = a[a.length - 1].ownerDocument, k.map(a, Pe), f = 0; f < s; f++)
                                    (l = a[f]),
                                        ye.test(l.type || "") &&
                                            ...
                                            k.contains(c, l) &&
                                            (l.src && "module" !== (l.type || "").toLowerCase() ? k._evalUrl && !l.noModule && k._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c) : w(l.textContent.replace(qe, ""), l, c));
                        }
                        return e;
                    }
                    function We(e, t, n) {
                    ...
                    k.extend({
                        ...
                        clone: function (e, t, n) {
                            var r,
                                ...
                                s = e.cloneNode(!0),
                                u = se(e);
                            if (!(v.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || k.isXMLDoc(e))) for (a = be(s), r = 0, i = (o = be(e)).length; r < i; r++) Me(o[r], a[r]);
                            if (t)
                    ...
                    function nt(e, t, n, r, i, o) {
                        ...
                        for (; a < 4; a += 2)
                            "margin" === n && (u += k.css(e, n + oe[a], !0, i)),
                                r
                                    ? ("content" === n && (u -= k.css(e, "padding" + oe[a], !0, i)), "margin" !== n && (u -= k.css(e, "border" + oe[a] + "Width", !0, i)))
                                    : ((u += k.css(e, "padding" + oe[a], !0, i)), "padding" !== n ? (u += k.css(e, "border" + oe[a] + "Width", !0, i)) : (s += k.css(e, "border" + oe[a] + "Width", !0, i)));
                    ...
                    function rt(e, t, n) {
                        ...
                        return (
                            ((!v.boxSizingReliable() && i) || (!v.reliableTrDimensions() && j(e, "tr")) || "auto" === a || (!parseFloat(a) && "inline" === k.css(e, "display", !1, r))) &&
                            ...
                            k.cssHooks[t] = {
                                ...
                                set: function (e, n, r) {
                                    ...
                                    return (
                                        ...
                                        u && (i = ie.exec(n)) && "px" !== (i[3] || "px") && ((e.style[t] = n), (n = k.css(e, t))),
                                        tt(0, n, u)
                                    );
                                },
                            };
                    ...
                    var ot,
                        ...
                        ut = /queueHooks$/;
                    function lt() {
                        at && (!1 === x.hidden && r.requestAnimationFrame ? r.requestAnimationFrame(lt) : r.setTimeout(lt, k.fx.interval), k.fx.tick());
                    }
                    function ct() {
                        return (
                            r.setTimeout(function () {
                    ...
                    function dt(e, t, n) {
                        ...
                        for (
                            !(function (e, t) {
                                var n, r, i, o, a;
                                for (n in e)
                                    if (((i = t[(r = G(n))]), (o = e[n]), Array.isArray(o) && ((i = o[1]), (o = e[n] = o[0])), n !== r && ((e[r] = o), delete e[n]), (a = k.cssHooks[r]) && ("expand" in a)))
                    ...
                    (k.Animation = k.extend(dt, {
                            ...
                            function (e, t, n) {
                                ...
                                if ((u = !k.isEmptyObject(t)) || !k.isEmptyObject(d))
                                    for (r in (f &&
                                        ...
                                        "none" === (c = k.css(e, "display")) && (l ? (c = l) : (de([e], !0), (l = e.style.display || l), (c = k.css(e, "display")), de([e]))),
                                    ...
                                    d))
                                        u ||
                                            ...
                                            g && de([e], !0),
                                            p.done(function () {
                                                for (r in (g || de([e]), K.remove(e, "fxshow"), d)) k.style(e, r, d[r]);
                                            })),
                                            (u = pt(g ? v[r] : 0, r, p)),
                        ...
                        k.each({ slideDown: ft("show"), slideUp: ft("hide"), slideToggle: ft("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
                        ...
                        k.fn.extend({
                            ...
                            toggleClass: function (e, t) {
                                ...
                                return m(e)
                                    ...
                                    : ((n = bt(e)),
                                      this.each(function () {
                                          if (s) for (o = k(this), i = 0; i < n.length; i++) (r = n[i]), o.hasClass(r) ? o.removeClass(r) : o.addClass(r);
                                          else
                                              (void 0 !== e && "boolean" !== a) ||
                        ...
                        k.fn.extend({
                            ...
                            serializeArray: function () {
                                return this.map(function () {
                                    ...
                                    .filter(function () {
                                        var e = this.type;
                                        return this.name && !k(this).is(":disabled") && jt.test(this.nodeName) && !Nt.test(e) && (this.checked || !ve.test(e));
                                    })
                                    .map(function (e, t) {
                                        var n = k(this).val();
                                        return null == n
                    ...
                    ($t.href = kt.href),
                        k.extend({
                            ...
                            ajax: function (e, t) {
                                ...
                                if (
                                    (v.promise(C),
                                    (d.url = ((e || d.url || kt.href) + "").replace(Mt, kt.protocol + "//")),
                                ...
                                if ((d.data && d.processData && "string" != typeof d.data && (d.data = k.param(d.data, d.traditional)), _t(It, d, t, C), l)) return C;
                                ...
                                d.hasContent
                                    ...
                                    : ((p = d.url.slice(i.length)),
                                      d.data && (d.processData || "string" == typeof d.data) && ((i += (St.test(i) ? "&" : "?") + d.data), delete d.data),
                                      !1 === d.cache && ((i = i.replace(Ot, "$1")), (p = (St.test(i) ? "&" : "?") + "_=" + Et.guid++ + p)),
                                      (d.url = i + p)),
                                ...
                                C.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : d.accepts["*"]),
                                d.headers))
                                    C.setRequestHeader(f, d.headers[f]);
                                if (d.beforeSend && (!1 === d.beforeSend.call(h, C, d) || l)) return C.abort();
                                if (((T = "abort"), m.add(d.complete), C.done(d.success), C.fail(d.error), (n = _t(Wt, d, t, C)))) {
                                ...
                                function E(e, t, a, u) {
                                    ...
                                    l ||
                                        ...
                                        !f && k.inArray("script", d.dataTypes) > -1 && k.inArray("json", d.dataTypes) < 0 && (d.converters["text script"] = function () {}),
                                        (b = (function (e, t, n, r) {
                                            var i,
                                                o,
                                                a,
                                        ...
                                        f
                                            ? (d.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (k.lastModified[i] = w), (w = C.getResponseHeader("etag")) && (k.etag[i] = w)),
                    ...
                    k.ajaxSetup({
                        ...
                        k.ajaxPrefilter("json jsonp", function (e, t, n) {
                            ...
                            if (s || "jsonp" === e.dataTypes[0])
                                return (
                                    ...
                                    s ? (e[s] = e[s].replace(Gt, "$1" + i)) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
                                    ...
                                    n.always(function () {
                                        void 0 === o ? k(r).removeProp(i) : (r[i] = o), e[i] && ((e.jsonpCallback = t.jsonpCallback), Qt.push(i)), a && m(o) && o(a[0]), (a = o = void 0);
                                    }),
                                    "script"
                                );
                        }),
                        ...
                        (k.parseHTML = function (e, t, n) {
                            return "string" != typeof e
                                ...
                                : ("boolean" == typeof t && ((n = t), (t = !1)),
                                  ...
                                  (o = !n && []),
                                  (i = L.exec(e)) ? [t.createElement(i[1])] : ((i = Ce([e], t, o)), o && o.length && k(o).remove(), k.merge([], i.childNodes)));
                            var r, i, o;
                        }),
                        ...
                        k.each(["top", "left"], function (e, t) {
                            k.cssHooks[t] = Ve(v.pixelPosition, function (e, n) {
                                if (n) return (n = Xe(e, t)), Fe.test(n) ? k(e).position()[t] + "px" : n;
                            });
                        }),
                    ...
                    return (
                        (k.noConflict = function (e) {
                            return r.$ === k && (r.$ = Kt), e && r.jQuery === k && (r.jQuery = Jt), k;
                        }),
    ...
    (e = r(19755)),
        (function (t) {
            var n = window.location.host.toLowerCase(),
                r = n.indexOf("www.") > -1 ? "" : "www.",
                i = "https:" == document.location.protocol ? "https://" : "http://",
                o = i + n,
                a = 0;
            function s() {
                e(
                    '<div class="default-dialog feedback-dialog" >\n                <div class=\'dialog-body\'>\n                    <div class="dialog-close top" >X</div>\n                    <div class="dialog-content">\n                        <h2 class="tip-title">新版本调查</h2>\n                        <div class="row">\n                            <p>请问您对猫咪此次改版是否满意：</p>\n                            <input type="radio" name="likes" id="like" value="1" checked >满意<br>\n                            <input type="radio" name="likes" id="unlike" value="0" >不满意<br>\n                        </div>\n                        <div class="row">\n                            <p>反馈意见：</p>\n                            <textarea id="feedback_content"></textarea>\n                        </div>\n                    </div>\n                    <div class="btn dialog-submit bottom" >提交</div>\n                </div>\n            </div>'
                ).appendTo("body"),
                    e(".dialog-close").on("click", function () {
                        e(".feedback-dialog").remove();
                    }),
                    e(".dialog-submit").on("click", function () {
                        var t, n, r;
                        (t = a),
                            (n = e("#feedback_content").val()),
                            (r = { like: 0 == t ? 0 : 1, content: n }),
                            window.postEnterData(r, "/index/feedback", function (e, t, n) {
                                0 === e || window.openMsgDialog(t);
                            });
                    }),
                    e('input[name="likes"]').on("click", function () {
                        a = e(this).val();
                    });
            }
            window.addEventListener(
                "DOMContentLoaded",
                (function () {
                    window.feedback && (window.getcookiess("feedback_num") > 0 || ((a = 0), s(), window.setcookiess("feedback_num", 1, 12))),
                        (function () {
                            e(".yj-url").attr("href", o + "/help/help.html"), e("#website").text(o);
                            var t =
                                "今日最新域名\r\n" +
                                i +
                                r +
                            ...
                            e(".tiaozhuan").attr("data-clipboard-text", t),
                                new ClipboardJS(".tiaozhuan").on("success", function (e) {
                                    confirm(
                                        "正在进入本站中\r\n已经自动复制本站域名，请粘贴到微信或者QQ或者备忘录里。\r\n本站由于经常被屏蔽域名，请务必多保存地址，以防丢失本站。\r\n如果您觉得本站还不错，可以粘贴本站链接发送给好友，感谢～"
                                    ) && (window.location.href = o + "/index.php?mod=index"),
                                        e.clearSelection();
                                });
                        })();
                    var t = document.getElementById("canvas");
                    alert(o);
                    window.QRCode.toCanvas(t, o, function (e) {
                        e && console.error(e);
                    });
                    var u = t.toDataURL("image/png");
                    e("#link-website-qrcode").attr("href", u);
                })(),
                !1
            );
        })(window);
